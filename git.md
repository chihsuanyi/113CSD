...
-----
<img src="https://github.com/chihsuanyi/113CSD/blob/main/image/blob1.png" width="500"/>
...
- 若不用此 option，hash-object 指令預設會從檔案中讀取，所以必須在 hash-object 指令之後加上指定的檔案路徑
 (例如：_git hash-object README.md_)
-----
<img src="https://github.com/chihsuanyi/113CSD/blob/main/image/blob2.png" width="500"/>
...
-----
<img src="https://github.com/chihsuanyi/113CSD/blob/main/image/blob3.png" width="500"/>
...
<img src="https://github.com/chihsuanyi/113CSD/blob/main/image/config.png" width="500"/>

- **logs 資料夾**：列出所有 commit 的歷史記錄。會列出每一筆 commit 的 SHA-1 校驗碼、作者名字及電子郵件、寫入日期以及提交訊息。

<img src="https://github.com/chihsuanyi/113CSD/blob/main/image/logs.png" width="700"/>
...
1.2 scope（可選）：commit 影響的範圍

如：資料庫、控制層、模板層等，視專案不同改變

 1.3 subject（必要）：commit 的簡短描述
